...
**Dinas Perhubungan mempunyai tugas pokok melaksanakan urusan pemerintahan daerah bidang perhubungan, menarik perhatian publik menjadi sarana untuk sosialisai program, pelayanan, dan tugas.**
...
Bank Sumsel Babel desires an application that can manage and monitor key performance indicators of each employee from the headquarters to its branches, to identify employees who have successfully achieved targets and those needing improvement.
...
SUHU memerlukan platform pembelajaran yang dapat mempertemukan antara pengguna dengan mentor sehingga dapat berinteraksi dan berkonsultasi tentang materi yang dapat menunjang karier pengguna..
...
**Digitalisasi pengelolaan inventory dan transaksi dari cara konvensional.**
...
Based on the agency's needs, TLab developed a multi-platform application focusing on digitizing the transaction processes of the Jaya Motor Bukittinggi store for easier monitoring of daily income and expenditure data from headquarters to branches. TLab also added a stock-taking feature that facilitates users in reconciling warehouse stocks with the application.

For multi-platform requirements, TLab chose to use the Codeigniter framework technology for ease of transaction management via the website, printing tags connected to barcode printers, and a mobile application for stock-taking processes using the Kotlin programming language.
...
# Sub Portofolio – Sepatu Jolifa - Digitalisasi Perpustakaan Terpusat
...
Sepatu Jolifa menawarkan kemudahan kepada masyarakat dalam mengakses sumber informasi seluruh perpustakaan DIY. Layanan ini merupakan satu-satunya di Indonesia yang menerapkan pengelolaan perpustakaan dengan sistem interlibrary loan tingkat provinsi.

Dinas Perpustakaan dan Arsip Daerah

Yogyakarta

Lingkup Kerja 2016 - 2023
...
Sepatu Jolifa offers convenience to the public in accessing information from all libraries in DIY. This service is the only one in Indonesia that implements provincial-level interlibrary loan management for libraries.

Regional Library and Archives Office

Yogyakarta

Service Delivered . 2016-2023
...
**Kebutuhan Digitalisasi Perpustakaan Terpusat.**

DPAD ingin mengembangkan website yang menyediakan informasi dari seluruh perpustakaan di Yogyakarta dan menerapkan interlibrary loan dari tiap-tiap perpustakaan yang terpilih sehingga pengguna dapat meminjam buku dari mana perpustakaan mana pun hanya dengan satu kartu anggota.

### Inggris

**Centralized Library Digitalization Needs.**

DPAD wants to develop a website that provides information from all libraries in Yogyakarta and implements interlibrary loans from selected libraries so that users can borrow books from any library with just one membership card.
...
**Development of a platform for centralized management of book data and cross-library borrowing in DIY.**

Dari kebutuhan instansi, TLab mengembangkan responsive website yang fokus pada interlibrary loan dari semua perpustakaan yang ada di wilayah Yogyakarta yang sudah bekerjasama. Website tersebut juga user friendly yang memudahkan pengguna dalam mencari informasi maupun buku dari semua perpustakaan.

Untuk menjaga performance website, TLab Laravel Framework yang fleksibel dan stabil serta database PostgreSQL untuk penyimpanan datanya. Website juga terintegrasi dengan Vufind yang difungsikan untuk mengambil data buku dari semua perpustakaan.

### Inggris

**Development of a POS system to manage thousands of inventory items and transactions since 2012 that is scalable.**

Based on institutional needs, TLab is developing a responsive website focused on interlibrary loans from all cooperating libraries in the Yogyakarta region. The website is also user-friendly, making it easy for users to search for information and books from all libraries.

To maintain website performance, TLab chooses the flexible and stable Laravel Framework, along with the PostgreSQL database for data storage. The website is also integrated with Vufind to retrieve book data from all libraries.
...
Website simulasi akreditasi perpustakaan untuk sekolah-sekolah di wilayah Yogyakarta.
...
Library accreditation simulation website for schools in the Yogyakarta region.
...
**Kebutuhan Simulasi Akreditasi Perpustakaan.**

Tim Pembinaan Perpustakaan DPAD ingin mengembangkan aplikasi simulasi akreditasi perpustakaan untuk semua instansi pendidikan di Yogyakarta agar dapat mengetahui instansi mana saja yang dapat diajukan untuk mengikuti akreditasi nasional.

### Inggris

**Library Accreditation Simulation Needs.**

The Library Development Team at DPAD wishes to develop a library accreditation simulation application for all educational institutions in Yogyakarta, enabling them to identify which institutions are eligible to undergo national accreditation.
...
**Pengelolaan dan pengelompokan data perpustakaan yang terakreditasi lintas lembaga di DIY.**

Berdasarkan kebutuhan instansi, TLab mengembangkan website yang responsive dan fokus pada kemudahan pengguna untuk melakukan simulasi akreditasi perpustakaan. Dari simulasi tersebut, Tim Pembinaan akan dapat mengetahui profil masing-masing perpustakaan yang sudah terakreditasi maupun belum.

TLab pun concern dengan performance website agar nyaman digunakan dan mudah dalam melakukan simulasi. Maka, teknologi yang dipilih adalah Laravel Framework dengan database PostgreSQL.

### Inggris

**Management and grouping of data for accredited libraries across institutions in DIY.**

Based on institutional needs, TLab develops a responsive website focused on user-friendly library accreditation simulation. Through this simulation, the Development Team will be able to understand the profile of each accredited and non-accredited library.

TLab is also concerned with website performance to ensure it is comfortable to use and efficient in simulations. Therefore, they chose Laravel Framework with PostgreSQL database technology.
...
# Sub Portofolio – Website Media Informasi Pelatihan SUHU
...
Menawarkan solusi peningkatan kompetensi SDM yang komprehensif untuk menjawab tantangan di Era Digital.

PT Kata Suhu Kita

Yogyakarta

Lingkup Kerja 2023 - 2024
...
Offering comprehensive human resources competency enhancement solutions to address challenges in the Digital Era.

PT Kata Suhu Kita

Yogyakarta

Service Delivered . 2023-2024
...
**Kebutuhan Digitalisasi Media Informasi Pelatihan SUHU.**

SUHU menginginkan website untuk media informasi yang akan menampilkan layanan dan pelatihan yang dimiliki SUHU agar mudah dalam memperoleh klien baru, penambahan testimoni dan dokumentasi pelatihan untuk meningkatkan kepercayaan pengunjung website.

### Inggris

**Digitalization Needs of SUHU Training Information Media.**

SUHU wants a website for informational media that will showcase SUHU's services and training offerings, making it easier to attract new clients. They also aim to include testimonials and training documentation to enhance visitor trust on the website.

## Testimonial

### Indonesia

**Muhammad Isnaini - Direktur PT Kata Suhu Kita**
...
**Pengembangan website yang responsive fokus pada Performance dan SEO Friendly.**

TLab membuat website yang fokus pada SEO dengan mengimplementasikan semantic HTML dan metadata secara lengkap. Selain itu, TLab juga concern dalam performance agar pengunjung merasa nyaman dan mudah dalam mencari informasi pelatihan di website SUHU.

Dengan Kebutuhan tersebut, TLab memilih untuk menggunakan teknologi tepat guna yaitu Laravel sebagai framework bahasa pemrograman PHP dan PostgreSQL untuk pengelolaan database. Website SUHU juga terintegrasi dengan Google Analytics dan Semrush untuk memantau trafik pengunjung.

### Inggris

**Development of a responsive website focused on Performance and SEO Friendliness.**

TLab creates a website focused on SEO by implementing semantic HTML and complete metadata. Additionally, TLab is also concerned with performance to ensure visitors feel comfortable and can easily find training information on the SUHU website.

With these needs, TLab chooses to use appropriate technology, namely Laravel as the PHP programming language framework and PostgreSQL for database management. The SUHU website is also integrated with Google Analytics and Semrush to monitor visitor traffic.
...
Kita akan berbicara, kita akan berjalan, kita tidak akan pernah melewatkan satu ketukan pun. TLab adalah tempat di mana keajaiban terjadi. Pikiran luar biasa, rencana luar biasa, sinergi luar biasa. Ayo semua, bergabunglah dengan TLab!

### Inggris

**Optimistic Vibes**

We're gonna talk, we're gonna walk, we'll never skip a beat. TLab's the place where magic happens. Amazing minds, amazing plans, amazing synergy. Come on everybody, join the TLab!

## Benefits

### Indonesia

**TLab berdedikasi untuk memberikan fasilitas terbaik setiap saat**

Menyediakan fasilitas terbaik yang dirancang untuk meningkatkan produktivitas, kreativitas, dan pengalaman Anda secara keseluruhan.

**(Slideshow)**

- Pengembangan karir (Tagline) - **TLabCircle Internal**

Kegiatan ini merupakan Self Development untuk meningkatkan hard skill Talent di TLab terkait materi seputar Technology Development dari Pemateri Talent TLab untuk Audience TLab Group.

- Pengembangan karir (Tagline) - **TLabCircle External**

Kegiatan ini merupakan Self Development untuk meningkatkan hard skill Talent di TLab terkait materi seputar Technology Development dari Pemateri Eksternal untuk Audience TLab Group.

- Pengembangan karir (Tagline) - **TLabCircle University**

Kegiatan ini merupakan Self Development untuk meningkatkan soft skill Talent di TLab Group, Pemateri dari Eksternal dan Audience untuk TLab Group.

- Pengembangan karir (Tagline) - **Program kepimpinan**

Kegiatan ini merupakan Self Development untuk meningkatkan soft skill dan leadership Talent di TLab Group, Pemateri dari Internal dan Eksternal dan Audience untuk TLab Group.

- Pengembangan karir (Tagline) - **TLab Group Guyub**

Kegiatan ini merupakan kegiatan berkumpul untuk dapat menjalin silaturahmi dan mempererat kebersamaan antar TLab Group yang banyak satu sama lain jarang bertemu ataupun baru saja bertemu sehingga Talent dapat saling guyub dan bisa mengenal satu sama lain.

- Kegiatan Perusahaan (Tagline) - **Ulang Tahun Perusahaan**

Kegiatan untuk memeriahkan ulang tahun Tahun Perusahaan dan mengartikan bahwa perusahaan dapat berkembang hingga sejauh itu. Perayaan ulang tahun perusahaan juga mengartikan bahwa perusahaan bisa semakin bersinergi, menjadi waktu untuk berefleksi, dan membuktikan reputasi perusahaan

- Kegiatan Perusahaan (Tagline) - **Buka Puasa Bersama**

Untuk mempererat kebersamaan dan menjalin silaturahmi antara seluruh Talent TLab group

- Kegiatan Perusahaan (Tagline) - **Halal Bi Halal**

Untuk melaksanakan halal bihalal setelah hari raya idul fitri dan sebagai bentuk silaturahmi, mempererat hubungan, serta meminta maaf dan memaafkan antara satu dengan yang lain.

- Kegiatan Perusahaan (Tagline) - **Komunitas Olahraga**

Kegiatan yang bertujuan sebagai ajang stress release talent dengan membentuk komunitas olahraga. Pada kegiatan tersebut, perusahaan memberikan support dengan cara memberikan dana operasional untuk jalannya komunitas.

- Kegiatan Perusahaan (Tagline) - **Rapat Umum Perusahaan**

Kegiatan penyampaian progres perusahaan dan Kegiatan yang akan dilaksanakan oleh perusahaan kedepannya.

- Keuntungan (Tagline) - **Tlab Fit**

Benefit yang diberikan oleh perusahaan kepada talent dengan memberikan support dana untuk membeli kebutuhan yang berhubungan dengan olahraga dan kesehatan setiap bulannya. Tujuannya supaya talent dapat fit sehingga talent dapat produktif.

- Keuntungan (Tagline) - **Tlab Chit Chat**

Benefit yang diberikan oleh perusahaan kepada talent dengan memberikan support dana untuk bisa saling berkumpul dan mengobrol sehingga menjalin kedekatan satu sama lain. Chit-chat dapat dilakukan minimal 2 orang talent TLab. bisa berupa kegiatan makan bersama, nonton film bersama ataupun yang lainnya

### Inggris

**TLab is dedicated to delivering top-notch facilities at all times**

Providing top-notch facilities designed to enhance your productivity, creativity, and overall experience..

**(Slideshow)**

- People Development (Tagline) - **TLabCircle Internal**

This activity is a self-development program aimed at enhancing the hard skills of Talents at TLab related to Technology Development, presented by TLab Talent instructors for the TLab Group audience.

- People Development (Tagline) -**TLabCircle External**

This activity is a self-development program aimed at enhancing the hard skills of Talents at TLab, focused on Technology Development topics, presented by external speakers for the TLab Group audience.

- People Development (Tagline) - **TLabCircle University**

This activity is a self-development program aimed at enhancing the soft skills of Talents in the TLab Group, with external speakers and an audience from the TLab Group.

- People Development (Tagline) - **Leadership Program**

This activity is a self-development program aimed at enhancing the soft skills and leadership abilities of Talents in the TLab Group, with speakers from both internal and external sources, and an audience from the TLab Group.

- People Development (Tagline) - **TLab Group Guyub**

This event is a gathering activity to foster friendships and strengthen the bond among TLab Group members, many of whom rarely meet or have just met each other. This allows the Talents to come together and get to know one another.

- Company Event (Tagline) - **Company Anniversary**

An event to celebrate the company's anniversary, signifying its growth and progress over the years. The celebration also symbolizes the company's increasing synergy, serves as a time for reflection, and demonstrates the company's reputation.

- Company Event (Tagline) - **Iftar Gathering**

To strengthen togetherness and foster friendships among all Talents of the TLab group.

- Company Event (Tagline) - **Halal Bi Halal**

To hold a halal bihalal after Eid al-Fitr as a form of fostering friendships, strengthening relationships, and seeking and giving forgiveness to one another.

- Company Event (Tagline) - **Sport Community**

An activity aimed at providing stress relief for Talents by forming sports communities. In this activity, the company supports by providing operational funds for the community's activities.

- Company Event (Tagline) - **Town Hall Meeting**

An activity to present the company's progress and the activities that will be carried out by the company in the future..

- Allowance (Tagline) - **Tlab Fit**

The benefit provided by the company to talents includes financial support to purchase sports and health-related necessities every month. The goal is to ensure that talents stay fit and productive.

- Allowance (Tagline) - **Tlab Chit Chat**

The benefit provided by the company to talents includes financial support for gatherings and conversations to foster closer relationships. Chit-chat can be done with at least 2 TLab talents and can involve activities like dining together, watching movies, or other similar activities.
...
**Vacancy List (Tergantung lowongan yang tersedia)**

- Head Of Business Development Section (Fulltime - Jakarta)
- Strategic Product Manager (Contract - Jakarta)

Apakah Anda tidak menemukan peluang kerja yang sesuai dengan minat Anda? Lamar
...
Are you not finding job opportunities that match your interests? Apply
...
**Mendapatkan Informasi Dan Pengetahuan dengan TLab**

Apakah Anda mencari inspirasi, wawasan, dan tips berharga untuk meningkatkan pengetahuan dan keterampilan Anda? Jangan khawatir! Blog kami adalah tempat yang tepat, menyediakan beragam sumber daya untuk membantu Anda.

### Inggris

**Getting Information And Knowledge With TLab**

Are you looking for inspiration, insights, and valuable tips to enhance your knowledge and skill? Look no further! Our blog is a treasure trove of knowledge, offering a wealth of resources to help you.

## Highlight News

### Indonesia

**NgabuburIT 2025, Elevate Your Skills While Waiting for Iftar**

The highly anticipated NgabuburIT 2025 is back! A successful collaboration between TLab, JURU, and SUHU, this event took place throughout March 2025, during the holy month of Ramadan. It provided a unique opportunity to upskill while waiting for iftar, featuring insightful webinars on the latest trends in IT, security, big data, cloud computing, and smart HR solutions. Why Join NgabuburIT? For those looking to expand their knowledge and career prospects in IT &amp; HR, this interactive event...
...
- Iftar Gathering TLab Family - 15 Mar 2025 - Acara
- Munggahan, Menyambut Ramadan dengan Kebahagiaan dan Kebersamaan di TLab - 27 Feb 2025 - Acara
- Empowering Government Digital Transformation with AI, Big Data an Blockchain - 25 Feb 2025 - Umum
- Menginspirasi Masa Depan, SMK Telkom Lampung Berkunjung ke Kantor Pusat TLab - 12 Feb 2025 - Umum
- Collaborative Internship Program between TLab and Universitas Muhammadiyah Yogyakarta - 30 Nov 2024 - Partnerships
- TLab University, Interpersonal and Communication Skills Development - 31 Oct 2024 - Culture
- Techminton 2024, A Smash Hit for the IT Community in Yogyakarta - 17 Aug 2024 - Partnerships
- Celebrating Independence Day with TLab - 17 Aug 2024 - Event
- Mid Year Townhall A First for TLab - 19 Jul 2024 - Culture

### Inggris

- Iftar Gathering TLab Family - 15 Mar 2025 - Event
- Munggahan, Welcoming Ramadan with Joy and Togetherness at TLab - 27 Feb 2025 - Event
- Empowering Government Digital Transformation with AI, Big Data an Blockchain - 25 Feb 2025 - General
- Inspiring the Future, SMK Telkom Lampung Visits TLab Head Office - 12 Feb 2025 - General
- Collaborative Internship Program between TLab and Universitas Muhammadiyah Yogyakarta - 30 Nov 2024 - Partnerships
- TLab University, Interpersonal and Communication Skills Development - 31 Oct 2024 - Culture
- Techminton 2024, A Smash Hit for the IT Community in Yogyakarta - 17 Aug 2024 - Partnerships
- Celebrating Independence Day with TLab - 17 Aug 2024 - Event
